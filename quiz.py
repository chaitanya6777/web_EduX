...
def select_fixed_questions(questions, answers, num_questions):
    ...
    selected_indices = random.sample(range(len(questions)), num_questions)#creating a list of indices whose length is num_questions
...
def app():
    ...
    # assigning file name to file_path here
    file_path = "demo.txt"
